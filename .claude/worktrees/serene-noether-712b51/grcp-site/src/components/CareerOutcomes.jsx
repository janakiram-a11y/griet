export default function CareerOutcomes({ college }) {
  return (
    <section className="w-full bg-[#F6F1F2] py-[80px] px-[120px]">
      <div className="max-w-[1200px] mx-auto flex items-center gap-24">
        <div className="flex flex-col flex-1 gap-6">
          <div>
            <p className="font-poppins font-bold text-[20px] leading-[30px] uppercase text-[#5B1127] mb-3">
              {college.careerLabel}
            </p>
          ...
          <div className="flex">
            <div className="flex-1 pl-6 border-l-2 border-[#5B1127] flex flex-col gap-1">
            ...
            <div className="flex-1 pl-6 border-l-2 border-[#B89047] flex flex-col gap-1">
