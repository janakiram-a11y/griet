...
export default function DepartmentPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white overflow-x-hidden">
          ...
          <ul className="flex flex-col gap-4">
            {dept.peos.map((item, i) => (
              <li key={i} className="flex items-start gap-4 bg-white rounded-xl px-6 py-4 shadow-sm">
                ...
                <span className="font-montserrat font-normal text-[15px] leading-[27px] text-[#374151]">{item}</span>
              </li>
            ))}
          </ul>
        </div>
      ...
      <div className="w-full section-pad" style={{ backgroundColor: '#5B0D2D' }}>
      ...
      <div className="w-full section-pad" style={{ backgroundColor: '#1A1A2E' }}>
        <div className="flex flex-col items-center gap-2 mb-10 text-center">
          <p className="font-montserrat font-semibold text-[11px] tracking-[0.2em] uppercase text-white/50">
            What We Offer
          </p>
