    ...
    <section className="w-full bg-[#5B0D2D] section-pad">
      <div className="max-w-[1200px] mx-auto flex items-center gap-0">
        <div className="flex flex-col gap-6 w-[600px]">
          ...
          <p className="font-montserrat font-normal text-[18px] leading-[22px] text-[#E1D3D9]">
            {college.academicProgramsDesc}
          </p>
          <div className="flex items-center gap-4 mt-2">
            <button
              className="bg-[#E6A31E] text-white font-montserrat font-semibold text-[18px] leading-[22px] px-8 py-[19px] rounded hover:bg-[#d49218] transition-colors"
          ...
          {college.academicPrograms.map(({ count, title, desc }, i) => {
            ...
            return (
              ...
              >
                ...
                <div>
                  <span className="font-poppins font-bold text-[32px] leading-[38px] text-[#E6A31E] block">{count}</span>
                  <span className="font-poppins font-bold text-[20px] leading-7 text-white block">{title}</span>
                </div>
                <p className="font-montserrat font-normal text-[14px] leading-[17px] text-[#E1D3D9]">{desc}</p>
