...
export default function Footer({ college }) {
  return (
    <footer className="w-full bg-white pt-[48px] pb-8 px-5 md:pt-[60px] md:pb-10 md:px-[60px] lg:pt-[80px] lg:pb-10 lg:px-[120px]">
      <div className="max-w-[1200px] mx-auto">
            ...
            <ul className="flex flex-col gap-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a
                  ...
                  className="font-montserrat font-normal text-[14px] leading-5 text-[#474747]"
                >
                  {college.email}
                </a>
              </li>
        ...
        {/* Bottom bar */}
        <div className="border-t border-[#1E2939] pt-8 flex justify-between items-center">
