  ...
  return (
    <section className="relative w-full overflow-hidden" style={{ minHeight: '260px' }}>
      ...
      <div className="relative z-10 w-full px-5 py-10 md:px-[60px] md:py-[60px] lg:px-[120px] lg:py-[80px] flex flex-col gap-4">
        ...
        <h1
          className="font-poppins font-bold text-[42px] leading-[52px] text-white max-w-[700px]"
          style={{ filter: 'drop-shadow(0px 2px 4px rgba(0,0,0,0.15))' }}
        >
          {title}
        </h1>
        {subtitle && (
          <p className="font-montserrat font-normal text-[16px] leading-[26px] max-w-[580px]" style={{ color: 'rgba(255,255,255,0.80)' }}>
            {subtitle}
          </p>
        )}
