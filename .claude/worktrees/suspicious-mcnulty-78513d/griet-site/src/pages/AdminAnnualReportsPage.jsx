      ...
      <div className="space-y-8">
        ...
        >
          <div>
            ...
            <p className="font-poppins font-bold text-[20px]">Annual Report 2024–25</p>
            <p className="font-montserrat text-[13px] mt-1 opacity-80">
              Covers academic year 2024–25 including accreditation updates, research highlights, and placement statistics.
            </p>
          </div>
          <a
            href="#"
            className="flex-shrink-0 inline-flex items-center gap-2 px-5 py-2.5 rounded font-poppins font-semibold text-[13px] transition-opacity hover:opacity-90 text-white border-2 border-white/60"
          >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {reports.map(({ year, file }) => (
              ...
              >
                ...
                <div>
                  <p className="font-poppins font-semibold text-[14px] group-hover:underline" style={{ color: college.primaryColor }}>
                    Annual Report
                  </p>
                  <p className="font-montserrat text-[13px] text-gray-500">{year}</p>
                </div>
