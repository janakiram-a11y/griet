    ...
    <AdministrationLayout title="Academic Council">
      <div className="space-y-8">
        ...
        {categories.map(({ label, members }) => (
          <div key={label}>
            <h3
              className="font-poppins font-semibold text-[14px] uppercase tracking-wide mb-3 pb-1.5 border-b"
                  ...
                  {members.map((m, i) => (
                    <tr key={m.sno} className={i % 2 === 0 ? 'bg-white' : 'bg-gray-50'}>
                      ...
                      <td className="px-4 py-2.5 border-b border-gray-100 font-semibold text-gray-800">
                        ...
                        {m.role && (
                          <span
                            className="ml-2 text-[10px] px-1.5 py-0.5 rounded font-poppins font-bold text-white"
        ...
        {/* Functions */}
        <section className="bg-[#F3DAB2] rounded-lg p-6 border border-gray-200">
          <h3 className="font-poppins font-bold text-[16px] mb-4" style={{ color: college.primaryColor }}>
            Key Functions
          </h3>
          <ul className="space-y-2">
            {[
              ...
              <li key={item} className="flex items-start gap-2.5 font-montserrat text-[13px] text-gray-700">
