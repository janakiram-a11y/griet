    ...
    <AcademicsLayout title="Regulations">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-8">
        {[
          ...
          <div key={label} className="rounded-lg p-4 text-center" style={{ backgroundColor: '#faf7f2', border: `1px solid ${college.primaryColor}22` }}>
            <div className="font-poppins font-bold text-[22px] leading-none mb-1" style={{ color: college.primaryColor }}>{code}</div>
            <div className="font-montserrat text-[11px] text-gray-500 font-medium mt-1">{label}</div>
          </div>
        ))}
      </div>

      <p className="font-montserrat text-[13px] text-gray-500 italic mb-5">
