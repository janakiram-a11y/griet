    ...
    <AdministrationLayout title="IDMC">
      <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {activities.map(({ title, desc }) => (
              <div key={title} className="bg-white rounded-lg border border-gray-200 p-5 hover:shadow-sm transition-shadow">
                <h4 className="font-poppins font-semibold text-[14px] mb-2" style={{ color: college.primaryColor }}>
                  {title}
                </h4>
        ...
        <section className="bg-[#F3DAB2] rounded-lg border border-gray-200 p-5">
          ...
          <p className="font-montserrat text-[13px] text-gray-600 mb-3">
          ...
          <a
            href="/research#mous"
            className="inline-flex items-center gap-2 font-montserrat font-semibold text-[13px] hover:underline"
