...
function SectionTitle({ children }) {
  return (
    <h2 className="font-poppins font-bold text-[20px] mb-5 pb-2" style={{ color: college.primaryColor, borderBottom: `2px solid ${college.primaryColor}22` }}>
      {children}
    </h2>
  );
}
...
function SubHeading({ children }) {
  return (
    <h3 className="font-poppins font-semibold text-[15px] mt-6 mb-2" style={{ color: college.primaryColor }}>
      {children}
    </h3>
  );
}
...
function Body({ children }) {
  return <p className="font-montserrat text-[13px] leading-relaxed text-gray-700 mb-2">{children}</p>;
}
  ...
  return (
    <AdmissionsLayout title="Scholarships Academic Year 2024-25">
      ...
      <section className="mb-12">
        ...
        <p className="font-montserrat text-[13px] text-gray-600 mb-5">
            ...
            <div
              ...
              style={
                highlight
                  ...
                  : { backgroundColor: '#faf7f2', border: `1px solid ${college.primaryColor}33` }
              }
            >
              <div
                className="font-poppins font-bold text-[26px] leading-none"
                style={{ color: highlight ? '#fff' : college.primaryColor }}
              >
                {amount}
              </div>
              <div
                className="font-montserrat text-[12px] font-semibold mt-1"
        ...
        {/* M.Tech */}
        <div className="rounded-lg p-4 flex items-start gap-3" style={{ backgroundColor: '#F3DAB2', border: `1px solid ${college.accentColor}55` }}>
      ...
      <section className="mb-12">
        ...
        <a href="#" className="font-montserrat text-[13px] font-semibold underline hover:opacity-75" style={{ color: college.primaryColor }}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {endowmentAwards.map((award, i) => (
            ...
            >
              <a
                href="#"
                className="font-poppins font-semibold text-[14px] underline hover:opacity-75 block mb-2"
                style={{ color: college.primaryColor }}
              >
                {i + 1}. {award.title}
              </a>
              {award.eligibility && (
                <p className="font-montserrat text-[12px] text-gray-500 leading-relaxed">
