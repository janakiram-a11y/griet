...
function AccordionSection({ entry, isOpen, onToggle, isCurrent }) {
  return (
    <div className="mb-2 rounded overflow-hidden">
      <button
        onClick={onToggle}
        className="w-full flex items-center justify-between px-5 py-3 text-left font-montserrat font-semibold text-[13px] transition-opacity hover:opacity-90"
        style={{
      ...
      {isOpen && !entry.rows && (
        <p className="font-montserrat text-[13px] text-gray-400 italic border border-dashed border-gray-300 rounded mx-0 p-4 mt-1">
...
export default function FeeStructurePage() {
  ...
  return (
    <AdmissionsLayout title="Fee Structure and Payment Procedure">
      ...
      {/* Online payment note */}
      <div className="mb-8 rounded-lg p-4 flex items-start gap-3" style={{ backgroundColor: '#F3DAB2', border: '1px solid #F3DAB2' }}>
        ...
        <p className="font-montserrat text-[13px] text-blue-800">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
        <div className="rounded-lg overflow-hidden border border-gray-200">
          <div className="px-5 py-3" style={{ backgroundColor: college.primaryColor }}>
            <p className="font-poppins font-bold text-white text-[15px]">B.Tech — 2025-26 Fee Summary</p>
          </div>
          <div className="p-5 bg-white">
            {[
              ...
              <div key={label} className="flex items-center justify-between py-2 border-b border-gray-100 last:border-0">
                <span className="font-montserrat text-[13px] text-gray-700">{label}</span>
                <span className="font-poppins font-bold text-[14px]" style={{ color: college.primaryColor }}>{amount}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="rounded-lg overflow-hidden border border-gray-200">
          <div className="px-5 py-3" style={{ backgroundColor: college.primaryColor }}>
            <p className="font-poppins font-bold text-white text-[15px]">M.Tech — 2025-26 Fee Summary</p>
          </div>
          <div className="p-5 bg-white">
            {[
