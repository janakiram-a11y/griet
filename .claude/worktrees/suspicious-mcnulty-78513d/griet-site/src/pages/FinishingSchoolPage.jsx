  ...
  return (
    <div className="flex justify-center my-6">
      <svg viewBox="0 0 400 290" className="w-full max-w-sm" xmlns="http://www.w3.org/2000/svg">
        ...
        <rect x="145" y="8" width="110" height="42" rx="6" fill="#BFBFBF" />
        ...
        <rect x="8" y="118" width="118" height="48" rx="6" fill="#F3DAB2" />
        <text x="67" y="138" textAnchor="middle" fill="#5B1027" fontFamily="Montserrat,sans-serif" fontSize="11.5" fontWeight="700">Entrepreneur</text>
        <text x="67" y="154" textAnchor="middle" fill="#5B1027" fontFamily="Montserrat,sans-serif" fontSize="11.5" fontWeight="700">ship</text>

        {/* Higher studies — middle right */}
        <rect x="274" y="118" width="118" height="48" rx="6" fill="#F3DAB2" />
        ...
        <circle cx="200" cy="210" r="70" fill="#C32033" />
