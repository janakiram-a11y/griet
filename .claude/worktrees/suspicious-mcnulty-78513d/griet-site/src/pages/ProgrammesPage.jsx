    ...
    <AdmissionsLayout title="Programmes">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-10">
        {[
          ...
          <div key={label} className="rounded-lg p-5 text-center" style={{ backgroundColor: '#faf7f2', border: `1px solid ${college.primaryColor}22` }}>
            <div className="font-poppins font-bold text-[28px] leading-none mb-1" style={{ color: college.primaryColor }}>{value}</div>
            <div className="font-montserrat text-[12px] text-gray-500 font-medium">{label}</div>
          </div>
        ))}
      </div>
      ...
      <div className="mb-8 p-5 rounded-lg bg-white border border-gray-200">
        <p className="font-poppins font-semibold text-[14px] mb-3" style={{ color: college.primaryColor }}>
          Seat Distribution — A.Y 2025–26
        </p>
        <ul className="font-montserrat text-[13px] text-gray-700 space-y-1.5">
      ...
      <p className="font-montserrat text-[12px] text-gray-500 mt-2">
