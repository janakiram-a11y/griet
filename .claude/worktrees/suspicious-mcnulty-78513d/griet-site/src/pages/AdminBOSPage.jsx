    ...
    <AdministrationLayout title="BOS">
      <div className="space-y-8">
        ...
        <section>
          ...
          <div className="bg-[#F3DAB2] rounded-lg border border-gray-200 p-5">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {deptsBOS.map((dept, i) => (
              ...
              >
                <span
                  className="w-7 h-7 rounded-full flex items-center justify-center text-white font-poppins font-bold text-[11px] flex-shrink-0"
                  style={{ backgroundColor: college.primaryColor }}
                >
                  {i + 1}
                </span>
                <span className="font-montserrat text-[13px] text-gray-700">{dept}</span>
              </div>
            ))}
          </div>
        </section>
