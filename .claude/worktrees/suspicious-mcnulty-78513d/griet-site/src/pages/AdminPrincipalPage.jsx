      ...
      <div className="space-y-8">
        ...
        <div className="bg-white rounded-lg border border-black/10 shadow-sm overflow-hidden">
          ...
          <div className="p-6 md:p-8">
            ...
            {/* Principal's message */}
            <blockquote
              className="mt-6 border-l-4 pl-5 py-2 italic font-montserrat text-[14px] leading-relaxed text-gray-700"
            ...
            <table className="w-full text-[13px] font-montserrat">
              <thead>
                <tr style={{ backgroundColor: college.primaryColor }}>
                  <th className="text-left px-4 py-2.5 text-white font-poppins font-semibold text-[12px] w-36">Category</th>
                  <th className="text-left px-4 py-2.5 text-white font-poppins font-semibold text-[12px]">Details</th>
                </tr>
              </thead>
              <tbody>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            {funding.map(({ agency, amount, purpose }) => (
              <div key={agency} className="bg-[#F3DAB2] rounded-lg p-4 border border-gray-200">
                <p
                ...
                <p className="font-poppins font-semibold text-[12px] mb-1.5" style={{ color: college.accentColor }}>
                  {agency}
                </p>
                <p className="font-montserrat text-[12px] text-gray-600">{purpose}</p>
              </div>
            ))}
          </div>
        </section>
