    ...
    <div className="bg-white rounded-lg border border-black/10 shadow-sm overflow-hidden">
      ...
      <div className="p-6">
        <div className="flex items-start gap-5">
          <div
            className="w-16 h-16 rounded-full flex items-center justify-center text-white font-poppins font-bold text-2xl flex-shrink-0"
            style={{ backgroundColor: college.primaryColor }}
          >
            {name.charAt(0)}
          </div>
          <div className="flex-1 min-w-0">
            <h3 className="font-poppins font-bold text-[18px] leading-snug" style={{ color: college.primaryColor }}>
              {name}
            </h3>
            <p className="font-montserrat text-[13px] font-semibold mt-0.5" style={{ color: college.accentColor }}>
              {role}
            </p>
            {qualification && (
              <p className="font-montserrat text-[12px] text-gray-500 mt-0.5">{qualification}</p>
            )}
            {badge && (
              <span
                className="inline-block mt-2 px-2.5 py-0.5 rounded-full text-[11px] font-poppins font-semibold text-white"
        ...
        {desc && (
          <p className="mt-4 font-montserrat text-[14px] leading-relaxed text-gray-600 border-t border-gray-100 pt-4">
            {desc}
          </p>
        )}
      </div>
  ...
  return (
    <AdministrationLayout title="Administration">
      ...
      <div className="space-y-10">
        ...
        {/* Inspirer */}
        <section className="rounded-lg bg-[#F3DAB2] border border-gray-200 p-6 md:p-8">
          <h3 className="font-poppins font-bold text-[18px] mb-1" style={{ color: college.primaryColor }}>
            The Inspirer
          </h3>
          <p className="font-montserrat text-[13px] font-semibold mb-3" style={{ color: college.accentColor }}>
