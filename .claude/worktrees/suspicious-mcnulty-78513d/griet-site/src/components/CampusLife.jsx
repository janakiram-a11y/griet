      ...
      <div className="flex flex-col gap-6">
        <div className="flex justify-between items-end">
          <div className="flex flex-col gap-4">
            <p className="font-poppins font-bold text-[14px] leading-5 uppercase tracking-[1.4px] text-[#5B1027]">
          ...
          <button className="border-2 border-[#5B1027] text-[#5B1027] font-montserrat font-medium text-[16px] leading-6 px-6 py-2 rounded-lg hover:bg-[#5B1027] hover:text-white transition-colors">
            Explore Gallery
          </button>
        </div>
