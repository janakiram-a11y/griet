...
const MortarIcon = () => (
  <svg viewBox="0 0 20 20" fill="none" className="w-5 h-5">
    <path d="M10 3L2 7l8 4 8-4-8-4z" stroke="#C32033" strokeWidth="1.5" strokeLinejoin="round" />
    <path d="M6 9v3.5c0 1.5 4 2.5 4 2.5s4-1 4-2.5V9" stroke="#C32033" strokeWidth="1.5" strokeLinecap="round" />
  </svg>
)
const UsersIcon = () => (
  <svg viewBox="0 0 20 20" fill="none" className="w-5 h-5">
...
export default function HighlightCards({ college }) {
  return (
    <section className="w-full bg-[#5B1027] px-4 py-[30px] md:px-[60px] md:py-[46px] lg:px-[120px]">
