        ...
        <div className="flex flex-col gap-[18px] max-w-[686px]">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              className="bg-[#C32033] text-white font-montserrat font-semibold text-[16px] leading-6 px-8 py-[14px] rounded hover:bg-[#a01c28] transition-colors inline-block"
            ...
            <a
              ...
              className="bg-white text-[#5B1027] font-montserrat font-semibold text-[16px] leading-6 px-8 py-[14px] rounded hover:bg-gray-50 transition-colors inline-block"
              style={{ boxShadow: '0px 10px 15px -3px rgba(0,0,0,0.1), 0px 4px 6px -4px rgba(0,0,0,0.1)' }}
            >
              Explore Programs
            </a>
