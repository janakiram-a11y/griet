...
function BookCard({ title, author }) {
  return (
    <div
      ...
      style={{ minHeight: 100 }}
    >
      <p className="font-montserrat font-semibold text-[12px] leading-snug text-gray-800 mb-2 group-hover:text-[color:var(--p)]"
        style={{ '--p': college.primaryColor }}>
        {title}
      </p>
      {author && (
        <p className="font-montserrat text-[11px] text-gray-400 mt-auto">{author}</p>
      )}
    </div>
  );
}
...
function ResourceCard({ label, sub, icon }) {
  return (
    ...
    >
      ...
      <div>
        <p className="font-poppins font-bold text-[14px]" style={{ color: college.primaryColor }}>{label}</p>
        <p className="font-montserrat text-[11px] text-gray-400 mt-0.5">{sub}</p>
      </div>
    </a>
  );
}
...
function LibraryLink({ label }) {
  return (
    <a
      href="#"
      className="flex items-center gap-2 font-montserrat text-[12.5px] font-medium py-1 hover:underline"
  ...
  return (
    <AcademicsLayout title="Library">
      ...
      <section className="mb-12">
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="font-montserrat text-[13.5px] leading-relaxed text-gray-700">
            ...
            <div className="mt-5 flex items-center gap-3 p-4 rounded-lg bg-gray-50 border border-gray-200 w-fit">
              ...
              <span className="font-montserrat font-semibold text-[13px] text-gray-700">Rashtriya e-Pustakalaya</span>
            </div>
          </div>
          ...
          <div className="w-full md:w-72 flex-shrink-0">
            ...
            <div className="rounded-xl overflow-hidden border border-gray-200">
              ...
              >
                ...
                <span className="font-poppins font-bold text-[13px] text-white">Open Hours</span>
              </div>
              {[
                ...
                >
                  <span className="font-montserrat text-[13px] font-semibold text-gray-700">{day}</span>
                  <span className="font-poppins font-bold text-[13px]" style={{ color: college.primaryColor }}>{time}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <div className="text-center pt-4 border-t border-gray-200">
        <a
          href="#"
          className="font-montserrat text-[13px] font-medium underline hover:opacity-75"
          style={{ color: college.primaryColor }}
        >
