...
const YEARS = [
  { year: 'EAPCET: 2025–26  First & Last Ranks – Dept. wise – III counselling', data: BRANCHES_2025 },
  { year: 'EAPCET: 2024–25  First & Last Ranks – Dept. wise', data: null },
  { year: 'EAPCET: 2023–24  First & Last Ranks – Dept. wise', data: null },
  { year: 'EAPCET: 2022–23  First & Last Ranks – Dept. wise', data: null },
  { year: 'EAPCET: 2021–22  First & Last Ranks – Dept. wise', data: null },
];
  ...
  return (
    <div className="overflow-x-auto mb-2">
      <table className="border-collapse" style={{ minWidth: 900 }}>
        <thead>
          <tr>
            <th rowSpan={3} style={{ ...thCell, minWidth: 70 }}>Branch</th>
            <th rowSpan={3} style={{ ...thCell, minWidth: 50 }}>B/G</th>
            {CATEGORIES.map((cat) => (
