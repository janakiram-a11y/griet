...
export default function TranscriptsCertificatesPage() {
  return (
    <AcademicsLayout title="Transcripts & Certificates">
      <p className="font-montserrat text-[13px] text-gray-600 mb-8 leading-relaxed">
        ...
        {SERVICES.map(({ title, icon, points }) => (
          ...
          >
            ...
            >
              ...
              <span className="font-poppins font-bold text-[13px] text-white">{title}</span>
            </div>
            <ul className="px-5 py-4 space-y-2">
              {points.map((pt, i) => (
                <li key={i} className="flex items-start gap-2 font-montserrat text-[12.5px] text-gray-700 leading-snug">
      ...
      <div className="mt-8 rounded-xl border border-gray-200 bg-white overflow-hidden">
        ...
        >
          ...
          <span className="font-poppins font-bold text-[13px] text-white">Transcript Application Form (Form No. 230)</span>
        </div>

        <div className="px-5 py-4">
          <p className="font-montserrat text-[12.5px] text-gray-600 mb-4 leading-relaxed">
          ...
          <div className="flex flex-wrap gap-3">
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg font-montserrat font-semibold text-[12.5px] text-white transition-opacity hover:opacity-90"
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg font-montserrat font-semibold text-[12.5px] border transition-colors hover:bg-gray-100"
