...
export default function ExaminationsSidebar() {
  ...
  return (
    <div className="rounded-lg border border-gray-200 lg:sticky lg:top-[176px]">
      ...
      >
        <span className="font-poppins font-bold text-[12.5px] text-white tracking-wide">
          Important Links
        </span>
      </div>
        ...
        {SIDEBAR_LINKS.map(({ label, href }) => {
          ...
          return (
            <li key={label}>
              <Link
                to={href}
                className="flex items-center gap-2.5 px-4 py-2.5 font-montserrat text-[12px] transition-colors hover:bg-gray-50"
