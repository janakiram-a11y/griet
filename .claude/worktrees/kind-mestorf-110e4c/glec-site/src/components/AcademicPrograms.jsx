...
export default function AcademicPrograms({ college }) {
  ...
  return (
    <section className="w-full bg-[#5B0D2D] py-12 px-6 md:py-[60px] md:px-[60px] lg:py-[80px] lg:px-[120px]">
      <div className="max-w-[1200px] mx-auto flex flex-col lg:flex-row items-start gap-10 lg:gap-12">
        ...
        <div className="flex flex-col gap-6 w-full lg:w-[320px] flex-shrink-0">
          ...
          <div className="flex flex-col gap-4 mt-2 w-full">
            <button
              className="w-full bg-[#E6A31E] text-white font-montserrat font-semibold text-[16px] leading-[22px] px-7 py-4 rounded hover:bg-[#d49218] transition-colors"
