...
function AwardTable({ award }) {
  return (
    <div className="mb-8">
      <h3 className="font-poppins font-bold text-[14px] text-center mb-0.5" style={{ color: college.primaryColor }}>
        {award.title}
      </h3>
      {award.subtitle && (
        <p className="font-montserrat text-[12px] text-center text-gray-500 mb-3">{award.subtitle}</p>
      )}
          ...
          return (
            <div key={key} className="rounded overflow-hidden border border-gray-200">
              <button
                ...
                className="w-full flex items-center justify-between px-5 py-3 font-montserrat font-bold text-[13px] text-white transition-opacity hover:opacity-90"
              ...
              {isOpen && awards.length === 0 && (
                <div className="px-5 py-6 bg-white text-center font-montserrat text-[13px] text-gray-400">
