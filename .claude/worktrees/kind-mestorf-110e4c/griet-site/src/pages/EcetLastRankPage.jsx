  ...
  return (
    <AdmissionsLayout title="ECET Last Rank">
      ...
      <div className="mb-8 rounded-lg p-5 border border-gray-200 bg-white">
        <p className="font-montserrat text-[13px] leading-relaxed text-gray-700 mb-2">
        ...
        <div className="flex items-center gap-4 mt-3">
          <span className="font-montserrat text-[13px] text-gray-500 bg-gray-100 rounded-full px-4 py-1.5">
            <strong>B</strong> — Boys
          </span>
          <span className="font-montserrat text-[13px] text-gray-500 bg-gray-100 rounded-full px-4 py-1.5">
            <strong>G</strong> — Girls
          </span>
          <span className="font-montserrat text-[12px] text-gray-400 italic">
      ...
      {YEARS.map(({ label, data }, idx) => (
        <section key={label} className="mb-10">
          ...
          >
            <h2 className="font-poppins font-bold text-[14px]" style={{ color: idx === 0 ? college.primaryColor : '#6b7280' }}>
              {label}
            </h2>
            {idx === 0 && (
              <span className="ml-auto font-montserrat text-[11px] font-semibold px-2 py-0.5 rounded-full text-white" style={{ backgroundColor: college.primaryColor }}>
                Latest
              </span>
            )}
          </div>
