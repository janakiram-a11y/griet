...
function DWCShieldLogo() {
  return (
    <svg viewBox="0 0 160 180" className="w-36 h-auto mx-auto" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Star accents */}
      <text x="26" y="113" textAnchor="middle" fill="#E6A31E" fontFamily="serif" fontSize="10">★</text>
      <text x="134" y="113" textAnchor="middle" fill="#E6A31E" fontFamily="serif" fontSize="10">★</text>
    </svg>
  );
}
...
function EndNowLogo() {
  return (
    <div className="inline-flex items-center justify-center gap-0 rounded overflow-hidden my-4">
      {/* END part */}
      <div
        className="px-5 py-3 font-poppins font-black text-[28px] text-white leading-none"
        style={{ backgroundColor: '#B71C1C' }}
      >
        END
      </div>
      {/* NOW part */}
      <div className="px-5 py-3 font-poppins font-black text-[28px] leading-none" style={{ backgroundColor: '#1a1a1a', color: '#fff' }}>
        NOW
      </div>
    </div>
  );
  ...
  return (
    <AcademicsLayout title="Digital Wellbeing Council">
      <div className="flex flex-col items-center text-center py-6 max-w-xl mx-auto">
        ...
        {/* Supported by */}
        <p className="font-montserrat text-[13px] text-gray-500 mt-6 mb-1">supported by</p>

        {/* END NOW logo */}
        <EndNowLogo />

        {/* Foundation tag */}
        <p className="font-montserrat font-semibold text-[11px] tracking-[0.18em] uppercase text-gray-500 -mt-2 mb-1">
          Foundation
        </p>

        {/* Tagline */}
        <p
          className="font-poppins font-bold text-[13px] tracking-[0.12em] uppercase mt-4 mb-6"
          style={{ color: '#1a1a1a' }}
        >
        ...
        {/* Description */}
        <p className="font-montserrat text-[14px] leading-relaxed text-gray-700 text-justify">
