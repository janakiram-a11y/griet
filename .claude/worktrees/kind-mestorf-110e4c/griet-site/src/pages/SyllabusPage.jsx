...
function RegulationGroup({ code, branches, isOpen, onToggle }) {
  ...
  return (
    <div className="mb-2">
      <button
        onClick={onToggle}
        className="w-full flex items-center justify-between px-5 py-2.5 rounded-full text-left font-montserrat font-semibold text-[13px] text-white transition-opacity hover:opacity-90"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-2.5">
            {branches.map((branch) => (
              <a
                key={branch}
                href="#"
                className="flex items-center gap-2 font-montserrat text-[13px] hover:underline"
  ...
  return (
    <div className="flex-1 min-w-0">
      <div className="flex items-center gap-3 mb-4">
        <h2 className="font-poppins font-bold text-[17px]" style={{ color: college.primaryColor }}>{title}</h2>
      ...
      <div className="flex flex-wrap gap-3 pt-4 border-t border-gray-200">
        {SPECIAL_LINKS.map((label) => (
          <a
            key={label}
            href="#"
            className="flex items-center gap-2 px-5 py-2.5 rounded font-montserrat font-semibold text-[13px] text-white hover:opacity-90 transition-opacity"
