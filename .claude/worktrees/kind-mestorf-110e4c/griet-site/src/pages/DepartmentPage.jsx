...
const BookIcon = () => (
  <svg viewBox="0 0 20 20" fill="none" className="w-5 h-5">
    <path d="M4 4h12v13H4zM4 4a3 3 0 013-3h6a3 3 0 013 3" stroke="#B89047" strokeWidth="1.5" strokeLinejoin="round" />
    <path d="M7 8h6M7 11h4" stroke="#B89047" strokeWidth="1.5" strokeLinecap="round" />
  </svg>
);
const FlaskIcon = () => (
  <svg viewBox="0 0 20 20" fill="none" className="w-5 h-5">
    <path d="M7 3v6L3 16h14L13 9V3" stroke="#B89047" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M6 3h8" stroke="#B89047" strokeWidth="1.5" strokeLinecap="round" />
    <circle cx="9" cy="13" r="1" fill="#B89047" />
  </svg>
);
const StarIcon = () => (
  <svg viewBox="0 0 20 20" fill="none" className="w-5 h-5">
...
const BriefcaseIcon = () => (
  <svg viewBox="0 0 20 20" fill="none" className="w-5 h-5">
    <rect x="2" y="7" width="16" height="10" rx="2" stroke="#B89047" strokeWidth="1.5" />
    <path d="M6 7V5a2 2 0 014 0v2M6 7h8" stroke="#B89047" strokeWidth="1.5" strokeLinecap="round" />
  </svg>
);
const ChipIcon = () => (
  <svg viewBox="0 0 20 20" fill="none" className="w-5 h-5">
    <rect x="5" y="5" width="10" height="10" rx="1" stroke="#B89047" strokeWidth="1.5" />
    <path d="M8 5V3M12 5V3M8 17v-2M12 17v-2M5 8H3M5 12H3M17 8h-2M17 12h-2" stroke="#B89047" strokeWidth="1.5" strokeLinecap="round" />
  </svg>
);
...
const visionBgs = ['#1B3A4B', '#5B1127', '#1A1A2E', '#2D2D2D'];
...
function DeptQuickLinks({ dept }) {
  ...
  return (
    <section className="w-full bg-[#F6F1F2] py-12 px-6">
...
export default function DepartmentPage() {
  ...
  return (
    <CollegeLayout college={college}>
      ...
      <div className="max-w-[1100px] mx-auto px-6 md:px-10 py-12 space-y-14">
